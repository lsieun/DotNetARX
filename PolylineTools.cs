...
namespace DotNetARX
{
    public static class PolylineTools
    {
        ...
        /// <param name="points">多段线的顶点</param>
        public static void CreatePolyline(this Polyline pline, Point3dCollection points)
        {
        ...
        /// <param name="pline">多段线对象</param>
        /// <param name="points">多段线的顶点</param>
        public static void CreatePolyline(this Polyline pline, Point2dCollection points)
        {
            for (int i = 0; i < points.Count; i++)
            {
                // 添加多段线的顶点
        ...
        /// <param name="pline">多段线对象</param>
        /// <param name="points">多段线的顶点</param>
        public static void CreatePolyline(this Polyline pline, params Point2d[] points)
        {
            pline.CreatePolyline(new Point2dCollection(points));
        }
        ...
        public static void CreatePolygon(this Polyline pline, Point2d centerPoint, int number, double radius)
        {
            ...
            for (int i = 0; i < number; i++)
            {
                Point2d pt = new Point2d(
                    centerPoint.X + radius * Math.Cos(i * angle),
        ...
        public static void CreatePolyArc(this Polyline pline,
            Point2d centerPoint, double radius,
            double startAngle, double endAngle)
        {
            // 计算多段线的顶点
            Point2d pt1 = new Point2d(
                centerPoint.X + radius * Math.Cos(startAngle),
