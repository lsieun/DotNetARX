...
namespace DotNetARX
{
    public static class EntityTools
    {
        ...
        /// 移动实体
        /// </summary>
        /// <param name="id">实体的 ObjectId</param>
        ...
        /// <returns>返回复制实体的 ObjectId</returns>
        ...
        /// <returns>返回镜像实体的 ObjectId</returns>
        ...
        /// <returns>返回偏移后的实体 Id 集合</returns>
        ...
        /// <returns>返回阵列后的实体集合的 ObjectId</returns>
        ...
        /// <param name="angle">以弧度表示的填充角度，正值表示逆时针方向旋转，负值表示顺时针方向旋转，如果角度为 0 则出错</param>
        /// <returns>返回阵列后的实体集合的 ObjectId</returns>
