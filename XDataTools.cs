...
namespace DotNetARX
{
    ...
    public static class XDataTools
    {
        ...
        public static void AddXData(this ObjectId id, string regAppName, TypedValueList values)
        {
            ...
            // 如里不存在名为 regAppName 的记录，则创建新的注册应用程序表记录
